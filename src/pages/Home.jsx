      ...
      <section className="section cta-section">
        <div className="container">
          ...
          <div className="cta-buttons">
            ...
            <Link to="/transforming-finance" className="btn btn-secondary">Transforming Finance (21-Hour)</Link>
            <Link to="/get-flyer" className="btn btn-secondary">Download Flyer</Link>
            <a
              href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_PLAYBOOK_MSG)}`}
              target="_blank"
              rel="noopener noreferrer"
